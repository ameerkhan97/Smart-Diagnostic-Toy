/*
 * File:   BUTTONS.c
 * Description: Handles interaction with the buttons
 */
...
#define TRNGL1 PORTDbits.RD2//pin 6
#define SQUARE1 PORTDbits.RD7//pin 37
#define CIRCL1 PORTDbits.RD1//pin 5
#define TRNGL2 PORTDbits.RD6//pin 36
#define SQUARE2 PORTDbits.RD5//pin 34
#define CIRCL2 PORTDbits.RD9//pin 7
